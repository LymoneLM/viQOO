...
ECHO.
aria2c.exe --max-concurrent-downloads=16 --max-connection-per-server=16 --split=16 --dir=bin\log %update1% | find "download completed." 1>nul 2>nul
...
aria2c.exe --max-concurrent-downloads=16 --max-connection-per-server=16 --split=16 --file-allocation=none %update2% | find "download completed." 1>nul 2>nul
